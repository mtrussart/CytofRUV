...
saveRDS(raw_data,paste(wd_data,"Raw_Data.rds",sep="/")) # not necessary to saved
...
# Temporary outdir = "/stornext/Bioinf/data/lab_speed/leong.l/outdir/"
