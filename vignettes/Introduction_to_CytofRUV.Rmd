...
```{r load and cluster data before CytofRUV normalisation}
  ...
  log_data=load_data(wd_data,metadata_filename,panel_filename,cofactor=NULL)
...
```{r ShinyApp on the raw data,eval=FALSE}
  ...
  # Perform Log transformation on raw data for app.
  log_daf <- log_data$daf
  ...
  CytofRUV::launch_Shiny(daf, log_daf)
```
